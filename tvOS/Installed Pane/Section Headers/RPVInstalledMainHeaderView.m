...
static CGFloat titleSize = 66;
static CGFloat dateSize = 24;
...
- (void)_configureViewsIfNecessary {
    if (!self.titleLabel) {
        ...
        self.titleLabel.font = [UIFont systemFontOfSize:titleSize weight:UIFontWeightBold];
    ...
    if (!self.dateLabel) {
        ...
        self.dateLabel.font = [UIFont boldSystemFontOfSize:dateSize];
