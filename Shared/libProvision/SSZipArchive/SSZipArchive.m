...
- (BOOL)writeFolderAtPath:(NSString *)path withFolderName:(NSString *)folderName withPassword:(nullable NSString *)password
{
    ...
    [SSZipArchive zipInfo:&zipInfo setAttributesOfItemAtPath:path isDirectory:YES];
...
- (BOOL)writeFileAtPath:(NSString *)path withFileName:(nullable NSString *)fileName compressionLevel:(int)compressionLevel password:(nullable NSString *)password AES:(BOOL)aes
{
    ...
    [SSZipArchive zipInfo:&zipInfo setAttributesOfItemAtPath:path isDirectory:NO];
...
+ (void)zipInfo:(zip_fileinfo *)zipInfo setAttributesOfItemAtPath:(NSString *)path isDirectory:(BOOL)isDir
{
    ...
    if (attr)
    {
        ...
        if (permissionsValue != nil) {
            ...
            // If a directory, add 0040000, 0040000 being the flag for a directory.
            NSInteger permissionsOctal = 0;
            if (isDir)
                permissionsOctal = 0040000 + permissionsShort;
            else
                permissionsOctal = 0100000 + permissionsShort;
